      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6 space-y-5">
        ...
        {loading ? (
          <div className="space-y-4">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="border border-gray-200 dark:border-stone-700 rounded-xl p-5 space-y-3 animate-pulse">
                <div className="h-4 bg-gray-100 dark:bg-stone-700 rounded w-1/4" />
                <div className="h-3 bg-gray-100 dark:bg-stone-700 rounded w-3/4" />
                <div className="h-3 bg-gray-100 dark:bg-stone-700 rounded w-2/3" />
              </div>
            ))}
          </div>
        ) : articles.length === 0 ? (
          <div className="py-24 text-center space-y-3">
            ...
            <p className="text-gray-500 dark:text-gray-400 font-medium">No articles saved yet.</p>
