  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex items-center gap-2 px-5 py-3 border-b border-gray-200">
        <Logo size={18} />
        <span className="font-bold text-stone-900 text-sm">ALEXANDRIA</span>
      </div>
      ...
      {loading && (
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center space-y-3">
            ...
            <p className="text-sm text-gray-500">Summarizing article…</p>
          </div>
        </div>
      )}
      ...
      {!loading && saved && (
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm font-medium text-stone-900">Saved to Alexandria</p>
